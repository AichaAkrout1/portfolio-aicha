...
function Service() {
  return (
    <section id='services' >
      <h5>What I Offer</h5>
      <h2>Services</h2>
      <div className="container services_container fadeInUp-animation" fade >
      <article className="service">
        <div className="service-head">
          <MdDeveloperMode style={{color:"1f1f38", marginLeft:"180px", fontSize:"1.8rem"}}/>
      ...
      <div className='crown'>
      <AiFillCrown style={{color: "#4dbfff",fontSize:"30px",marginTop:"19px", marginLeft:"10px"}} />
      <p>Web Developer</p>
      </div>
      <div className='thunbup'>
      <HiMiniHandThumbUp style={{color: "#4dbfff",fontSize:"30px",marginTop:"19px", marginLeft:"10px"}} />
